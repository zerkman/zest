...
static const uint8_t gradients[][2][3]={
  ...
  {{255 ,166 ,0   },{255 ,99  ,97  }},
  {{7   ,121 ,222 },{20  ,72  ,140 }},
  {{0x32,0x8B,0x31},{0x96,0xCF,0x24}},
  {{0x99,0x45,0xFF},{0x19,0xFB,0x9B}},
  {{0x06,0xEB,0x5B},{0x00,0x78,0xE6}},
  {{0xFE,0x37,0xAF},{0xFE,0x07,0x9C}},
  {{0   ,168 ,157 },{177 ,233 ,216 }},
  {{0xdc,0x26,0x26},{0xf5,0x9e,0x0b}},
};
