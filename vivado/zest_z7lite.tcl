...
#
# Generated by Vivado on Wed Aug 31 17:09:34 CEST 2022
...
# configurator, ddr_controller_interface, on_screen_display
  ...
  set idata [ create_bd_port -dir I -from 23 -to 0 idata ]
  ...
  set odata [ create_bd_port -dir O -from 23 -to 0 odata ]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports vid_clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins on_screen_display_0/pclk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins configurator_0/S_AXI_ACLK] [get_bd_pins ddr_controller_inter_0/M_AXI_ACLK] [get_bd_pins on_screen_display_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
