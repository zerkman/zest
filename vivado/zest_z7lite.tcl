...
#
# Generated by Vivado on Sun Mar 13 21:57:17 CET 2022
...
if { [get_files configurator.vhd] == "" } {
  import_files -quiet -fileset sources_1 ../hdl/configurator.vhd
}
if { [get_files ddr_controller_interface.vhd] == "" } {
  import_files -quiet -fileset sources_1 ../hdl/ddr_controller_interface.vhd
}
if { [get_files ram_tdp.vhd] == "" } {
  import_files -quiet -fileset sources_1 ../hdl/ram_tdp.vhd
}
if { [get_files osd.vhd] == "" } {
  import_files -quiet -fileset sources_1 ../hdl/osd.vhd
}
...
# module references:
# configurator, ddr_controller_interface, on_screen_display
  ...
  set idata [ create_bd_port -dir I -from 15 -to 0 idata ]
  set ide [ create_bd_port -dir I ide ]
  set ihsync [ create_bd_port -dir I ihsync ]
  set in_reg0_0 [ create_bd_port -dir I -from 31 -to 0 in_reg0_0 ]
  set in_reg1_0 [ create_bd_port -dir I -from 31 -to 0 in_reg1_0 ]
  set in_reg8_11_0 [ create_bd_port -dir I -from 127 -to 0 in_reg8_11_0 ]
  set ivsync [ create_bd_port -dir I ivsync ]
  set oD_0 [ create_bd_port -dir O -from 15 -to 0 oD_0 ]
  set odata [ create_bd_port -dir O -from 15 -to 0 odata ]
  set ode [ create_bd_port -dir O ode ]
  set ohsync [ create_bd_port -dir O ohsync ]
  ...
  set out_reg8_11_0 [ create_bd_port -dir O -from 127 -to 0 out_reg8_11_0 ]
  set ovsync [ create_bd_port -dir O ovsync ]
  ...
  # Create instance: on_screen_display_0, and set properties
  set block_name on_screen_display
  set block_cell_name on_screen_display_0
  if { [catch {set on_screen_display_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $on_screen_display_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins configurator_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins on_screen_display_0/s_axi]
  ...
  connect_bd_net -net IRQ_F2P_0_1 [get_bd_ports IRQ_F2P_0] [get_bd_pins xlconcat_0/In0]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports vid_clk] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins on_screen_display_0/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net configurator_0_out_reg8_11 [get_bd_ports out_reg8_11_0] [get_bd_pins configurator_0/out_reg8_11]
  ...
  connect_bd_net -net idata_0_1 [get_bd_ports idata] [get_bd_pins on_screen_display_0/idata]
  connect_bd_net -net ide_0_1 [get_bd_ports ide] [get_bd_pins on_screen_display_0/ide]
  connect_bd_net -net ihsync_0_1 [get_bd_ports ihsync] [get_bd_pins on_screen_display_0/ihsync]
  ...
  connect_bd_net -net in_reg8_11_0_1 [get_bd_ports in_reg8_11_0] [get_bd_pins configurator_0/in_reg8_11]
  connect_bd_net -net ivsync_0_1 [get_bd_ports ivsync] [get_bd_pins on_screen_display_0/ivsync]
  connect_bd_net -net on_screen_display_0_intr [get_bd_pins on_screen_display_0/intr] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net on_screen_display_0_odata [get_bd_ports odata] [get_bd_pins on_screen_display_0/odata]
  connect_bd_net -net on_screen_display_0_ode [get_bd_ports ode] [get_bd_pins on_screen_display_0/ode]
  connect_bd_net -net on_screen_display_0_ohsync [get_bd_ports ohsync] [get_bd_pins on_screen_display_0/ohsync]
  connect_bd_net -net on_screen_display_0_ovsync [get_bd_ports ovsync] [get_bd_pins on_screen_display_0/ovsync]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins on_screen_display_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins configurator_0/S_AXI_ACLK] [get_bd_pins ddr_controller_inter_0/M_AXI_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_ports resetn] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins configurator_0/S_AXI_ARESETN] [get_bd_pins ddr_controller_inter_0/M_AXI_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs configurator_0/S_AXI/reg0] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs on_screen_display_0/s_axi/reg0] -force
