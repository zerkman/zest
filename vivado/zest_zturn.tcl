...
#
# Generated by Vivado on Fri Dec 17 16:32:00 CET 2021
...
set orig_proj_dir "[file normalize "$origin_dir/../../xilinx/zest_zturn"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse ps_domain.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../xilinx/zest_zturn/zest_zturn.srcs/sources_1/bd/ps_domain/hdl/ps_domain_wrapper.vhd" ]
} else {
