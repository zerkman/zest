...
if { [get_files memory_if_axi.vhd] == "" } {
...
# bridge_host, memory_if_axi
  ...
  connect_bd_net -net irq_f2p [get_bd_ports irq_f2p] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net ram_a [get_bd_ports ram_a] [get_bd_pins memory_if_axi_0/ram_a]
  connect_bd_net -net ram_w_d [get_bd_ports ram_w_d] [get_bd_pins memory_if_axi_0/ram_w_d]
  connect_bd_net -net ram_r_d [get_bd_ports ram_r_d] [get_bd_pins memory_if_axi_0/ram_r_d]
  connect_bd_net -net ram_w [get_bd_ports ram_w] [get_bd_pins memory_if_axi_0/ram_w]
  connect_bd_net -net ram_r [get_bd_ports ram_r] [get_bd_pins memory_if_axi_0/ram_r]
  connect_bd_net -net ram_ds [get_bd_ports ram_ds] [get_bd_pins memory_if_axi_0/ram_ds]
  connect_bd_net -net ram_w_done [get_bd_ports ram_w_done] [get_bd_pins memory_if_axi_0/ram_w_done]
  connect_bd_net -net ram_r_done [get_bd_ports ram_r_done] [get_bd_pins memory_if_axi_0/ram_r_done]
  connect_bd_net -net rom_a [get_bd_ports rom_a] [get_bd_pins memory_if_axi_0/rom_a]
  connect_bd_net -net rom_r_d [get_bd_ports rom_r_d] [get_bd_pins memory_if_axi_0/rom_r_d]
  connect_bd_net -net rom_r [get_bd_ports rom_r] [get_bd_pins memory_if_axi_0/rom_r]
  connect_bd_net -net rom_r_done [get_bd_ports rom_r_done] [get_bd_pins memory_if_axi_0/rom_r_done]
  connect_bd_net -net ram_error [get_bd_ports ram_error] [get_bd_pins memory_if_axi_0/ERROR]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins bridge_host_0/s_axi_aresetn] [get_bd_pins memory_if_axi_0/m_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports clk] [get_bd_pins bridge_host_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins memory_if_axi_0/m_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK]
  ...
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces memory_if_axi_0/m_axi] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z020clg400-2 -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg400-2 -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
